...
/// Validate the certificate chain. This does not check the key usage.
///
/// Note: It is not possible to use the webpki or tls crates to validate the certificate chain (Which would be much simpler).
...
/// For this reason we use openssl x509 to validate the certificate chain.
